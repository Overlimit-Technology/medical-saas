...
import { useBoxDetailViewModel } from "./BoxDetailViewModel";

export default function BoxDetail({ boxId }: { boxId: string }) {
  const { state } = useBoxDetailViewModel(boxId);
  const { box, loading } = state;
