          ...
          <div className="flex w-full flex-col gap-4 lg:w-auto lg:items-end">
            ...
            <div className="w-full max-w-sm">
              ...
              <select
                ...
                onChange={(e) => actions.setSelectedPatientId(e.target.value)}
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        ...
        <form onSubmit={actions.handleSubmit} className="mt-4 grid gap-3 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <select
              value={state.form.treatmentId}
              onChange={(e) => actions.handleTreatmentChange(e.target.value)}
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"
            >
          ...
          <div>
            ...
            <input
              type="date"
              value={state.form.recordedAt}
              onChange={(e) => actions.handleFormChange("recordedAt", e.target.value)}
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"
            />
          </div>
          <div>
            ...
            <select
              ...
              onChange={(e) => actions.handleFormChange("status", e.target.value as FormState["status"])}
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => actions.handleFormChange("amount", e.target.value)}
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"
              placeholder={state.currentTreatment ? `${Math.round(state.currentTreatment.price)}` : "0"}
            />
          </div>
          <div className="md:col-span-2">
            ...
            <input
              ...
              maxLength={250}
              onChange={(e) => actions.handleFormChange("notes", e.target.value)}
              className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"
          ...
          <div className="md:col-span-1 md:self-end">
            <button
              type="submit"
              disabled={state.saving || !state.selectedPatientId || !state.form.treatmentId}
